...
#include "/home/sebastian/.src/suckless_solarized/dwm/colors-wal-dwm.h"
/* appearance */
...
static const char *fonts[]          = { "Iosevka:size=14:style=Regular","Symbols Nerd Font:size=20:style=Regular", };
...
/* tagging */
static const char *tags[] = { "term:1", "web:2", "file:3", "vm:4", "placeholder:5" };
